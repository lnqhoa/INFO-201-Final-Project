...
.syntax--source.syntax--python .syntax--variable.syntax--parameter {
  color: #d19a66;
        ...
        <body class='markdown-preview' data-use-github-style><p><strong>INFO 201 FINAL PROJECT</strong></p>
<p>Part 2: Technical Report</p>
<h2 id="food-availability-in-washington-state"><strong>"Food Availability in Washington State"</strong></h2>
<h4 id="code-name-food-for-thoughts">Code Name: <strong>Food for Thoughts</strong>.</h4>
<h4 id="team-members">Team Members:</h4>
<ul>
<li><strong>Anna Bloch</strong> </li>
<li><strong>Hoa Le</strong> (<a href="mailto:lnqhoa@uw.edu">lnqhoa@uw.edu</a>)</li>
<li><strong>Jess Suresh</strong></li>
<li><strong>Richard Dait</strong></li>
</ul>
<h4 id="10-introduction">1.0 Introduction:</h4></body>
      </html>
